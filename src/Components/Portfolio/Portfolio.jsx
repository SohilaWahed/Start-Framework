      ...
      <div className="py-10">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="gallery flex flex-col md:flex-row flex-wrap justify-center items-center">
            ...
            <div className="image md:w-1/2 lg:w-1/3 p-4 relative">
              <img className='rounded-md' src={poert2} alt="img-2" onClick={dispalyImage(poert2)} />
              <div className="rounded-md absolute top-0 right-0 left-0 bottom-0 m-4 bg-teal-500 opacity-0 hover:opacity-85 duration-[0.6s] ease-in flex justify-center items-center">
                <i className="text-white fa-solid fa-plus fa-6x"></i>
              </div>
            </div>
            <div className="image md:w-1/2 lg:w-1/3 p-4 relative">
              <img className='rounded-md' src={poert3} alt="img-3" onClick={dispalyImage(poert3)} />
              <div className="rounded-md absolute top-0 right-0 left-0 bottom-0 m-4 bg-teal-500 opacity-0 hover:opacity-85 duration-[0.6s] ease-in flex justify-center items-center">
                <i className="text-white fa-solid fa-plus fa-6x"></i>
              </div>
            </div>
            <div className="image md:w-1/2 lg:w-1/3 p-4 relative">
              <img className='rounded-md' src={poert1} alt="img-4" onClick={dispalyImage(poert1)} />
              <div className="rounded-md absolute top-0 right-0 left-0 bottom-0 m-4 bg-teal-500 opacity-0 hover:opacity-85 duration-[0.6s] ease-in flex justify-center items-center">
                <i className="text-white fa-solid fa-plus fa-6x"></i>
              </div>
            </div>
            <div className="image md:w-1/2 lg:w-1/3 p-4 relative">
              <img className='rounded-md' src={poert2} alt="img-5" onClick={dispalyImage(poert2)} />
              <div className="rounded-md absolute top-0 right-0 left-0 bottom-0 m-4 bg-teal-500 opacity-0 hover:opacity-85 duration-[0.6s] ease-in flex justify-center items-center">
                <i className="text-white fa-solid fa-plus fa-6x"></i>
              </div>
            </div>
            <div className="image md:w-1/2 lg:w-1/3 p-4 relative">
              <img className='rounded-md' src={poert3} alt="img-6" onClick={dispalyImage(poert3)} />
              <div className="rounded-md absolute top-0 right-0 left-0 bottom-0 m-4 bg-teal-500 opacity-0 hover:opacity-85 duration-[0.6s] ease-in flex justify-center items-center">
                <i className="text-white fa-solid fa-plus fa-6x"></i>
              </div>
            </div>
